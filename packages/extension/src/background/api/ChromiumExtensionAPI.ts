...
import { ChromiumWebNavigationAPI } from "./ChromiumWebNavigationAPI";
...
export class ChromiumExtensionAPI {
  ...
  readonly webNavigationAPI:ChromiumWebNavigationAPI

  constructor() {
    this.windowAPI = new ChromiumWindowAPI();
    this.tabAPI = new ChromiumTabAPI();
    this.webNavigationAPI = new ChromiumWebNavigationAPI();
